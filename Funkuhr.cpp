...
static uint8_t m_dcf77Pin = PIN_DCF77_SIG;
static uint8_t m_blinkPin = LED_BUILTIN;
static uint8_t m_startupPin = PIN_DCF77_STARTUP;
static bool m_invertedSignal = false;


// DCF time format struct 
struct DCF77Buffer  {
  unsigned long long prefix   :21;// proprietary
...
void Funkuhr::begin() {
    digitalWrite(PIN_DCF77_STARTUP, HIGH);  
}

void Funkuhr::end() {
    digitalWrite(PIN_DCF77_STARTUP, LOW);  
}
